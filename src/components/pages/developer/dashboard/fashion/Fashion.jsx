...
import FeatureTable from './FashionTable'
import ModalAddFeature from './ModalAddFashion'
import ModalError from '../../../../partials/modals/ModalError'
import FashionTable from './FashionTable'
import ModalAddFashion from './ModalAddFashion'
...
const Fashion = () => {
    ...
    const {
        ...
        isSearch ? "/v1/fashion/search" : "/v1/fashion", // endpoint
  ...
  return (
    ...
    <main className='w-[calc(100%-250px)]'>
        ...
        <div className='flex relative'>
            <div className='main-wrapper transition-all px-4 py-3 w-full'>
                ...
                <FashionTable isLoading={isLoading} fashion={fashion} isFetching={isFetching} setItemEdit={setItemEdit}/>
            </div>
    ...
    {store.isAdd && <ModalAddFashion itemEdit={itemEdit}/>}
